...
- [ ] **CrPC 1973**: only reachable archive snapshot is truncated at 1 MiB (incomplete). Still on the dev-sample placeholder until a complete official PDF is sourced.
- [ ] Old codes still to do: Constitution, Contract Act (+ other exam-priority acts)
