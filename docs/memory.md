...
- **Next action**: proofread pass over marginal-note wrap artifacts (bundles = artifacts of record), Vercel deploy + Phase 0 polish residuals, then remaining Phase-1 items (search polish, further acts as demand dictates).
